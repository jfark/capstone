	...
	template: `
		<div>
			...
			<div class="carousel-nav-buttons">
				<button class="previous-button" v-on:click="previous"><img src="images/LeftBlue.png"></button>
				<button class="next-button" v-on:click="next"><img src="images/RightBlue.png"></button>
			</div>
